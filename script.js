...
class Transacao {
    ...
    static pagamentoSalario (contaOrigem, contaDestino, idPagamento, dataDoPagamento, valorDoSalario){        
        if(contaOrigem instanceof Pessoa && valorDoSalario > 1000){
...
const Victor = new Empresa("01", "Vip", "16/05/2022", 156, 2798, 987654321, 1000, "Churros do Victor", "1011121314", "Victor@email.com.br", 1234567890, "16/05/2022");
...
console.log(Victor.saldo); // Deve retornar 1000
console.log(Victor.nomeFantasia); // Deve retornar Victor
console.log(Victor.historico); // Deve retornar []
...
console.log(Transacao.transferencia(Victor, Joao, 2, "20/07/2022", 500)); // Deve retornar {mensagem: "Transferência realizada com sucesso!"}

console.log(Victor.historico); // Deve retornar [{idTransacao: 2, dataDeTransacao: "20/07/2022", valorDaTransferencia: 500, tipo: "pagamento"}]
...
console.log(Victor.saldo); // Deve retornar 500
console.log(Joao.saldo); // Deve retornar 600

console.log(Transacao.deposito(Victor, 3, "02/07/2022", 650)); // Deve retornar {mensagem: "Depósito realizado com sucesso!"}

console.log(Victor.historico[1]); // Deve retornar [{idDeposito: 3, dataDoDeposito: "02/07/2022", valorDoDeposito: 650, tipo: "recebimento"}]
console.log(Victor.saldo); // Deve retornar 1150
