...
class Transacao {
    ...
    static pagamentoSalario (contaOrigem, contaDestino, idPagamento, dataDoPagamento, valorDoSalario){
        //verificar se a contaOrigem é uma instância da classe Pessoa
        //Caso seja, o valorDoSalario não pode ser maior que 1000
        //Caso não passe nesta validação deve retornar: "Seu limite máximo para este tipo de operação é de 1000, entre em contato com o banco!"
